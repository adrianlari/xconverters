...
const decimalToHex = (input: string) => {
...
const hexToBech32 = (input: string) => {
...
const bech32ToHex = (input: string) => {
...
const base64ToString = (input: string) => {
...
const hexToString = (input: string) => {
...
const denominatedToAmount = (input: string) => {
...
const amountToDenominate = (input: string) => {
...
const base64ToDecimal = (input: string) => {
	if (!checks.base64Value(input)) return;

	const res = base64ToString(input);

	if (!res || !checks.decimal(res.result)) return;
...
const decimalToBase64 = (input: string) => {
	if (!checks.decimal(input)) return;
...
const base64ToHexDecimal = (input: string) => {
	if (!checks.base64Value(input)) return;
